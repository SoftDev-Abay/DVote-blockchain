...
const abi = [
  ...
  "function getTotalVotes(uint256 voteId) view returns (uint256)",
  "function getTotalVotesCreated() view returns (uint256)",
  "function getUserVotingHistory(address user) view returns (uint256[])",
  "function getVote(uint256 voteId) view returns (string, address, uint256[], uint256)",
  "function getVoteResults(uint256 voteId) view returns (uint256[])",
  "function join()",
